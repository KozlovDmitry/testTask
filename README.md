...
```
{
    ...
    "answers": [                          // Принимает список объектов
        ...
        {
            "question": 30,          
            "answer": "Gitar"             // При выборе нескольких вариантов ответа их требуется перечислить через запятую
        }
    ]
}
```
...
> Добавлены всевозможные обработки ошибок и некорректного поведения пользователя/администратора
